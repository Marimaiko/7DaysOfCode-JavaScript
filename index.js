const movieContainer = document.querySelector('movieCard')
...
function renderMovie(movieCard) {
    // Renderizar toda a estrutura do filme na página
}

window.onload = function () {
    movieCard.forEach(movieCard => renderMovie(movieCard))
}

function renderMovie(movieCard) {

    const { title, image, rating, year, description, isFavorited } = movieCard
